...
require (
	code.cloudfoundry.org/go-diodes v0.0.0-20231102232033-2a479dfa9870
...
require (
	...
	github.com/InfluxCommunity/flux v0.194.3 // indirect
...
replace (
	github.com/influxdata/influxdb => github.com/jbooherl/influxdb v1.11.1-0.20240508173658-b72e6e911b3d
